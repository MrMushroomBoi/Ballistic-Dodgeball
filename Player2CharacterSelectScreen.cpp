...
int Player2CharacterSelectScreen::mSelectedCharacter = 0;

Player2CharacterSelectScreen::Player2CharacterSelectScreen() {
	...
	mRaccoonSelected = new GLTexture("Character Select.png", 0, 54, 25, 25);
	...
	mRabbitSelected = new GLTexture("Character Select.png", 28, 54, 25, 25);
	...
	mBearSelected = new GLTexture("Character Select.png", 55, 54, 25, 25);
...
void Player2CharacterSelectScreen::Update() {
...
void Player2CharacterSelectScreen::Render() {
	mBackground->Render();
...
int Player2CharacterSelectScreen::SelectedCharacter() {
	return mSelectedCharacter;
}

void Player2CharacterSelectScreen::ChangeSelectedCharacter(int change) {
